...
STR16 pTransactionText[] =
{
	...
	L"Items gefixt door %s betaald.",	//is used for the Shop keeper interface (repairs only). The dealers name will be appended to the end of the string.
};
...
STR16 pSkyriderText[] =
{
	L"%s is $%d betaald.", 			// skyrider was paid an amount of money
	L"%s heeft $%d tegoed.", 		// skyrider is still owed an amount of money
	L"Helicopter is klaar met tanken",	// skyrider has finished refueling
	...
	L"Helicopter is klaar om weer te vliegen.", // Skyrider was grounded but has been freed
	L"Helicopter heeft geen passagiers. Als je huurlingen in deze sector wil vervoeren, wijs ze dan eerst toe aan Voertuig/Helikopter.",
