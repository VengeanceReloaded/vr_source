...
STR16 gpStrategicString[] =
{
	...
	L"ВОЗДУШНЫЙ ШТУРМ",							//STR_PB_ENEMYPARATROOPERS_HEADER
};
...
CHAR16 TacticalStr[][ MED_STRING_LENGTH ] =
{
	...
	L"Agree to assist %s?", //TODO: translate
	L"Связка ключей",
...
STR16 pSkyriderText[] =
{
	L"Небесному %s заплачено $%d", 			// skyrider was paid an amount of money
	L"Вы все еще должны Небесному %s $%d.", 		// skyrider is still owed an amount of money
...
STR16 pHistoryStrings[] =
{
	...
	L"Получен огнемет от сержанта Кротта.",	// sevenfm: VR specifi quest
...
STR16	szBackgroundText_Value[]=
{
	...
	L" %s%d%% скорость восстановления энергии\n",
