...
STR16 pTransactionText[] =
{
	...
	L"Paid for items to be fixed by %s.",	//is used for the Shop keeper interface (repairs only). The dealers name will be appended to the end of the string.
};
...
STR16 pSkyriderText[] =
{
	...
	L"Helicopter has been refueled",	// skyrider has finished refueling
	...
	L"Helicopter is ready to fly once more.", // Skyrider was grounded but has been freed
...
STR16 pHistoryStrings[] =
{
	...
	L"Hank is out of business.",
	L"Howard provided cyanide to Queen Deidranna.",
	L"Met Hank - all purpose dealer in Salinas.",
	//46-50
	L"Met Howard - deals pharmaceuticals in Malino.",
	L"Met Perko - runs a small repair business.",
	L"Met Sam of Malino - runs a hardware shop.",
	L"Franz deals in electronics and other goods.",
	L"Arnold runs a repair shop in Doran.",
	//51-55
	L"Fredo repairs electronics in Doran.",
