...
STR16 gzIMPMajorTraitsHelpTextsPilot[]=
{
	...
	L"+%d%s szansy na uniknięcie pocisków ziemia-powietrze\n",
	L"+%d%s szansy na przypadkowe uszkodzenie helikopetra w czasie lotu\n",
	L"+%d%s szansy na spostrzeżenie wrogiej aktywności na lądzie\n",
...
{
	L"+%d%s szybkość podróży między sektorami gdy w pojeździe (poza helikopterem)\n",
	L"-%d%s zużycie paliwa w podróży gdy w pojeździe (poza helikopterem)\n",
};
