...
#define AWEFUL_EXTENDED_PANEL_STATS         0
#define GREAT_EXTENDED_PANEL_STATS          80
#define AWESOME_EXTENDED_PANEL_STATS        90
#define AWEFUL_EXTENDED_PANEL_EXP_LVL        1
#define GREAT_EXTENDED_PANEL_EXP_LVL         5
#define AWESOME_EXTENDED_PANEL_EXP_LVL        8
