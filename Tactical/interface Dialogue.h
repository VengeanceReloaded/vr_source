...
enum
{
	...
	// anv: VR = NPC actions
	NPC_ACTION_HISTORY_ENRICO = 800,
	NPC_ACTION_HISTORY_TRACONA_ACCESS,
	NPC_ACTION_HISTORY_CONMAN,
	NPC_ACTION_PLAY_QUOTE_47,
	NPC_ACTION_PLAY_QUOTE_48,
	NPC_ACTION_TRIGGER_BUYER_BY_CONMAN_PROXIMITY,

	NPC_ACTION_NURSE_GIVES_PLAYER_KEY = 806,

	NPC_ACTION_MENDAX_REQUESTOR = 807,
	NPC_ACTION_MENDAX_LEAVES_FOR_GOOD = 808,
	NPC_ACTION_DWIGHT_GIVES_SAMPLE_TO_RAJIV = 809,
	NPC_ACTION_RAJIV_GIVES_MONEY_TO_DWIGHT = 810,

	NPC_ACTION_RAJIV_GIVES_20000_TO_DWIGHT = 811,
	NPC_ACTION_DWIGHT_GIVES_FIRST_HALF_TO_PLAYER = 812,
	NPC_ACTION_DWIGHT_GIVES_MOST_OF_SECOND_HALF_TO_PLAYER = 813,
	NPC_ACTION_DWIGHT_GIVES_BACK_REST_OF_MONEY = 814,

	NPC_ACTION_CIA_BUYER_TO_PLAYER = 815,
	NPC_ACTION_TRACONIAN_BUYER_TO_PLAYER = 816,
};
