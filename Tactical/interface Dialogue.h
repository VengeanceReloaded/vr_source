...
enum
{
	...
	NPC_ACTION_MENDAX_REQUESTOR = 307,
	NPC_ACTION_MENDAX_LEAVES_FOR_GOOD = 308,
	NPC_ACTION_DWIGHT_GIVES_SAMPLE_TO_RAJIV = 309,
	NPC_ACTION_RAJIV_GIVES_MONEY_TO_DWIGHT = 310,
	// /VENGEANCE
