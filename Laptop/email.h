...
// anv: VR emails
#define	MERC_MIA_ON_OTHER_ASSIGNMENT	( JOHN_KULBA_MISSED_FLIGHT_3 + JOHN_KULBA_MISSED_FLIGHT_3_LENGTH )
#define	MERC_MIA_ON_OTHER_ASSIGNMENT_LENGTH	5

#define	MERC_MIA_FOUND_ALIVE	( MERC_MIA_ON_OTHER_ASSIGNMENT + MERC_MIA_ON_OTHER_ASSIGNMENT_LENGTH )
#define	MERC_MIA_FOUND_ALIVE_LENGTH	5

#define	MERC_MIA_FOUND_DEAD	( MERC_MIA_FOUND_ALIVE + MERC_MIA_FOUND_ALIVE_LENGTH )
#define	MERC_MIA_FOUND_DEAD_LENGTH	5

#define MERC_DEATH_MIA_PLACES 20;
#define MERC_DEATH_CAUSES 15;
#define MERC_MIA_CAUSES 8;

#define	WEEKLY_LEAKS_LENGTH		20
#define	WEEKLY_LEAKS_1			250
#define	WEEKLY_LEAKS_2			WEEKLY_LEAKS_1 + WEEKLY_LEAKS_LENGTH
#define	WEEKLY_LEAKS_3			WEEKLY_LEAKS_2 + WEEKLY_LEAKS_LENGTH
#define	WEEKLY_LEAKS_4			WEEKLY_LEAKS_3 + WEEKLY_LEAKS_LENGTH
#define	WEEKLY_LEAKS_5			WEEKLY_LEAKS_4 + WEEKLY_LEAKS_LENGTH
#define	WEEKLY_LEAKS_6			WEEKLY_LEAKS_5 + WEEKLY_LEAKS_LENGTH
#define	WEEKLY_LEAKS_7			WEEKLY_LEAKS_6 + WEEKLY_LEAKS_LENGTH
#define	WEEKLY_LEAKS_8			WEEKLY_LEAKS_7 + WEEKLY_LEAKS_LENGTH
#define	WEEKLY_LEAKS_9			WEEKLY_LEAKS_8 + WEEKLY_LEAKS_LENGTH
#define	WEEKLY_LEAKS_10			WEEKLY_LEAKS_9 + WEEKLY_LEAKS_LENGTH

#define	DEMAND_MONEY_BACK_LENGTH		10
#define	SAMPLE_BUYER_FARMER_CHEATED		WEEKLY_LEAKS_10 + WEEKLY_LEAKS_LENGTH
#define	SAMPLE_BUYER_CIA_CHEATED		SAMPLE_BUYER_FARMER_CHEATED + DEMAND_MONEY_BACK_LENGTH

#define	CONMAN_SPOTTED_LENGTH		5
#define	CONMAN_SPOTTED_1			SAMPLE_BUYER_CIA_CHEATED + CONMAN_SPOTTED_LENGTH
#define	CONMAN_SPOTTED_2			CONMAN_SPOTTED_1 + CONMAN_SPOTTED_LENGTH
#define	CONMAN_SPOTTED_3			CONMAN_SPOTTED_2 + CONMAN_SPOTTED_LENGTH
